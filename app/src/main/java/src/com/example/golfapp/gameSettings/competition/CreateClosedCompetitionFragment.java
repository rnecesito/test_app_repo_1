...
public class CreateClosedCompetitionFragment extends Fragment {
    ...
    private class InitLists extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if(success) {
                ...
                Spinner spinner = (Spinner) view_container.findViewById(id.closed_courses_spinner);
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        Button b = (Button) view.findViewById(id.closed_save_btn);
        date_view = (TextView) view.findViewById(id.closed_competition_date);
        ImageView iv = (ImageView) view.findViewById(id.closed_set_date);
        ...
        final EditText party_name = (EditText) view.findViewById(id.closed_competition_name);
        final Spinner course_name = (Spinner) view.findViewById(id.closed_courses_spinner);
        b.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                if(pn_val.matches("")) {
                    Toast.makeText(getActivity(), getResources().getString(R.string.jap_competition_name), Toast.LENGTH_SHORT).show();
                    return;
