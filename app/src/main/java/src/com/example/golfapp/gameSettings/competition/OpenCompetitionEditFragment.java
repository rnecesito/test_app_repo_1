...
public class OpenCompetitionEditFragment extends Fragment {
    View view_container;
    ...
    private class CompetitionUpdate extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String str = "";
            HttpClient httpclient = new DefaultHttpClient();
            HttpPut httppost = new HttpPut("http://zoogtech.com/golfapp/public/open-competition/"+text.toString());
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		return inflater
				.inflate(R.layout.fragment_edit_open_competition, container, false);
	}
        ...
        b.setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                ...
                if(pn_val.matches("")) {
                    ...
                    new CompetitionUpdate().execute(pn_val, p_date, p_date2, course_id+"");
                }
            }
        });
	}
