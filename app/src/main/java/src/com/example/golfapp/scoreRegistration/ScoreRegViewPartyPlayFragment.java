...
public class ScoreRegViewPartyPlayFragment extends BaseFragment {
    ...
    private View.OnClickListener listener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            /** End save */
            showFragmentAndAddToBackStack(new com.example.golfapp.scoreRegistration.ScoreRegistrationFragment());
        }
    };
